...
public class Elementspage {
  ...
  public void WebTables() throws InterruptedException,AWTException{ 
      ...
      js.executeScript("window.scrollBy(0,200)"); Thread.sleep(2000);
		  ...
		  js.executeScript("window.scrollBy(0,200)"); WebElement d1 =
		  wd.findElement(By.xpath("//*[@id='submit']")); Actions act = new Actions(wd);
  ...
  public void Links() throws InterruptedException, AWTException{ 
		  ...
		  wd.findElement(By.xpath("//*[@class='accordion']/div[1]/div/ul/li[6]")).click(); Thread.sleep(3000); rc.keyPress(MenuKeyEvent.VK_DOWN);
		  js.executeScript("window.scrollBy(0,100)");
		  Thread.sleep(3000); 
		  Actions act = new Actions(wd); 
		  WebElement f1 =wd.findElement(By.id("simpleLink"));
		  act.moveToElement(f1).click().build().perform(); Thread.sleep(3000);
		  ...
		  Thread.sleep(2000);
		  wd.findElement(By.xpath("//*[@class='col-12 mt-4 col-md-6']/div[2]/p[4]/a")).click(); Thread.sleep(2000); rc.keyPress(MenuKeyEvent.VK_DOWN);
		  Thread.sleep(2000);
		  wd.findElement(By.xpath("//*[@class='col-12 mt-4 col-md-6']/div[2]/p[5]/a")).click(); Thread.sleep(2000); rc.keyPress(MenuKeyEvent.VK_DOWN);
		  Thread.sleep(2000);
		  wd.findElement(By.xpath("//*[@class='col-12 mt-4 col-md-6']/div[2]/p[6]/a")).click(); Thread.sleep(2000); rc.keyPress(MenuKeyEvent.VK_DOWN);
		  Thread.sleep(2000);
		  wd.findElement(By.xpath("//*[@class='col-12 mt-4 col-md-6']/div[2]/p[7]/a")).click(); Thread.sleep(2000); rc.keyPress(MenuKeyEvent.VK_DOWN);
		  Thread.sleep(2000);
		  wd.findElement(By.xpath("//*[@class='col-12 mt-4 col-md-6']/div[2]/p[8]/a")).click(); Thread.sleep(2000); rc.keyPress(MenuKeyEvent.VK_DOWN);
		  Thread.sleep(2000);
